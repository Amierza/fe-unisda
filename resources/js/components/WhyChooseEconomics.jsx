const WhyChooseEconomics = () => {
  return (
    <div className="py-10 px-5 bg-white shadow-md rounded-lg lg:w-full lg:px-[12rem]">
      ...
      <ul className="list-disc ml-5 space-y-6 mt-7 mb-7 lg:text-lg">
        <li>
        ...
        <li>
          ...
          <ol className="ml-6 list-decimal mt-3 space-y-3">
            <li>KIP</li>
            <li>Pemda Lamongan</li>
            <li>Tahfidz</li>
            <li>Prestasi</li>
          </ol>
        </li>
        ...
        <li>
          <strong className="text-color-1">
            Kesadaran Sosial dan Kebijakan Publik:
          </strong>
          Memahami ekonomi membantu mahasiswa untuk memahami isu-isu sosial dan
          kebijakan publik, serta dampaknya terhadap masyarakat.
        </li>
      </ul>
...
export default WhyChooseEconomics;
